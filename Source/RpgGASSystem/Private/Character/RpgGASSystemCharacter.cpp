...
#include "Character/RpgGASSystemCharacter.h"
...
#include "RpgGASSystem/Public/Game/PlayerState/RPGPlayerState.h"
...
ARpgGASSystemCharacter::ARpgGASSystemCharacter()
{
...
void ARpgGASSystemCharacter::OnRep_PlayerState()
{
...
UAbilitySystemComponent* ARpgGASSystemCharacter::GetAbilitySystemComponent() const
{
	return RPGAbilitySystemComp;
}


void ARpgGASSystemCharacter::InitAbilityActorInfo()
{
...
void ARpgGASSystemCharacter::InitClassDefaults()
{
	...
	{
		if (const FCharacterClassDefaultInfo* SelectedClassInfo = ClassInfo->ClassDefaultsInfoMap.Find(CharacterTag))
		{
			if (IsValid(RPGAbilitySystemComp))
			{
...
void ARpgGASSystemCharacter::BindCallbacksToDependencies()
{
...
void ARpgGASSystemCharacter::BroadcastInitialValues()
{
...
void ARpgGASSystemCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void ARpgGASSystemCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ARpgGASSystemCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ARpgGASSystemCharacter::Look);
	}
	else
	{
...
void ARpgGASSystemCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ARpgGASSystemCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
